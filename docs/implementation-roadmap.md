...
- `server/.env.example` — `DATABASE_URL`, `JWT_SECRET`, `JWT_EXPIRY_HOURS`, `AWS_BUCKET`, `AWS_REGION`, `AWS_ACCESS_KEY_ID`, `AWS_SECRET_ACCESS_KEY`, `AI_SERVICE_URL`, `PORT`, `NDHU_CAS_BASE_URL`
