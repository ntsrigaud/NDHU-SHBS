...
func TestMain(m *testing.M) {
	...
	testApp.Post("/api/v1/images", authMW, func(c *fiber.Ctx) error { return image.RegisterImage(testDB, c) })
	testApp.Get("/api/v1/images/:id", func(c *fiber.Ctx) error { return image.GetImage(testDB, c) })
